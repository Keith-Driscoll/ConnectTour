...
class Login{
    ...
    private function dologinWithPostData()
    {
        ...
        if (empty($_POST['user_name'])) {
            ...
            $this->db_connection = new mysqli("eu-cdbr-azure-west-a.cloudapp.net", "be4333e100072e", "2cb22472", "ggl_main");
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($result_of_login_check->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->player_pass)) {
