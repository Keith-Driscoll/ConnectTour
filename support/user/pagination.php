				...
				if(i < jsonData.length){
					...
					var stringPart = `<div id="support-ticket" class="oneTournament">
											...
											<a class="selected-ticket" href="ticket.php?id=`+array[0]+`">	
												<row centered>
													<column cols="1">`+array[2]+`</column>
													<column cols="4">`+array[3]+`</column>
													<column cols="1" class="sm-hidden">`+readstring+`</column>
													<column cols="3">`+array[5]+`</column>
													<column cols="3">`+array[7]+`</column>
