...
<section id="content">
	...
	<div class="container filtersAndList">
		<row centered>
			...
			<!-- tour list -->
			<column class="bothColumns" cols="16">
					...
					<div class="tournamentsList">
						<div class="oneTournament tournamentListHeader">
										<row>
											...
											<column cols="2"><div class="width-12 giveMinWidth">Start date</div></column>
											<column cols="2"><div class="width-12 giveMinWidth">Start Time</div></column>												
										</row>						
						</div>			
