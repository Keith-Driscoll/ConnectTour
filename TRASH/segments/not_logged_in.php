    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <div>
                    <h1><a  class="navbar-brand" href="index.php">GGLeagues</a></h1>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="tournaments.php">COMPETE <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="tournaments.php?game=Hearthstone">Hearthstone</a>
                            </li>
                            <li><a href="tournaments.php?game=League_of_Legends">League of Legends</a>
                            </li>
                            <li><a href="tournaments.php?game=Starcraft_II">Starcraft II</a>
                            </li>
 ...
 <div id="loginModal" class="modal fade" tabindex="" role="dialog" aria-hidden="true">  
    <div class="col-lg-6 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
        <div class="panel panel-login">
            <button class="popup" data-toggle="modal" data-target="#loginModal">X</button>
            <span class="nav-left">
            </span>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<!-- Login Form-->
								<form id="login-form" onsubmit="window.location.reload() || alert('Successfully Logged In!');" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
									<div class="form-group">
								...
								<!-- Register Form -->
								<form id="register-form" onsubmit="window.location.reload() || alert('Registration successfull! Please login.');" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" style="display: none;">
									<div class="form-group">
